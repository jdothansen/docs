...
[OpenMetrics](https://github.com/OpenObservability/OpenMetrics) is an effort to standardize metric wire formatting built off of Prometheus text format. It is possible to scrape targets
